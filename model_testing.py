...
### --- Read And Handle Data To Model --- ###

# Import amphibian data
amphibian_df = pd.read_csv(
    "/Users/ljw/Projects/ModelsFromScratch/DataSources/Amphibians/dataset.csv", 
    delimiter=";", 
    skiprows=1
)
...
### --- Logistic Classification Testing --- ###